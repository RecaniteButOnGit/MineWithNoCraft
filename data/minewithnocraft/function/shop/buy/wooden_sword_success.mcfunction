...
give @s minecraft:wooden_sword[custom_data={mwnc:{shop_bound:1b,shop_sword_wooden:1b}},custom_name={text:"Wooden Sword",color:"yellow",italic:false},enchantment_glint_override=true] 1
