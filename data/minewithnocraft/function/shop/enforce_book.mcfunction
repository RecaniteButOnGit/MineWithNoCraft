...
execute if score #near_beacon_xz mwnc_calc matches 0 run clear @s minecraft:written_book[custom_data={mwnc:{shop_book:1b,ver:4b}}]
...
execute store result score #shop_book_count mwnc_calc run clear @s minecraft:written_book[custom_data={mwnc:{shop_book:1b,ver:4b}}] 0
execute if score #shop_book_count mwnc_calc matches 0 run clear @s minecraft:written_book[custom_data={mwnc:{shop_book:1b}}]
execute if score #shop_book_count mwnc_calc matches 2.. run clear @s minecraft:written_book[custom_data={mwnc:{shop_book:1b,ver:4b}}]
