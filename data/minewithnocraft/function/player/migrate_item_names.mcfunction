...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:wooden_pickaxe[custom_data={mwnc:{shop_bound:1b,shop_pick_wooden:1b}},custom_name={text:"Wooden Pickaxe",color:"yellow",italic:false},enchantment_glint_override=true] 1
scoreboard players set #owned_item mwnc_calc 0
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:wooden_sword[custom_data={mwnc:{shop_bound:1b,shop_sword_wooden:1b}},custom_name={text:"Wooden Sword",color:"yellow",italic:false},enchantment_glint_override=true] 1
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:stone_pickaxe[custom_data={mwnc:{shop_bound:1b,shop_pick_stone:1b}},custom_name={text:"Stone Pickaxe",color:"gray",italic:false},enchantment_glint_override=true] 1
scoreboard players set #owned_item mwnc_calc 0
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:stone_sword[custom_data={mwnc:{shop_bound:1b,shop_sword_stone:1b}},custom_name={text:"Stone Sword",color:"gray",italic:false},enchantment_glint_override=true] 1
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:iron_pickaxe[custom_data={mwnc:{shop_bound:1b,shop_pick_iron:1b}},custom_name={text:"Iron Pickaxe",color:"gray",italic:false},enchantment_glint_override=true] 1
scoreboard players set #owned_item mwnc_calc 0
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:iron_sword[custom_data={mwnc:{shop_bound:1b,shop_sword_iron:1b}},custom_name={text:"Iron Sword",color:"gray",italic:false},enchantment_glint_override=true] 1
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:golden_pickaxe[custom_data={mwnc:{shop_bound:1b,shop_pick_gold:1b}},custom_name={text:"Gold Pickaxe",color:"gold",italic:false},enchantment_glint_override=true] 1
scoreboard players set #owned_item mwnc_calc 0
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:golden_sword[custom_data={mwnc:{shop_bound:1b,shop_sword_gold:1b}},custom_name={text:"Gold Sword",color:"gold",italic:false},enchantment_glint_override=true] 1
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:diamond_pickaxe[custom_data={mwnc:{shop_bound:1b,shop_pick_diamond:1b}},custom_name={text:"Diamond Pickaxe",color:"aqua",italic:false},enchantment_glint_override=true] 1
scoreboard players set #owned_item mwnc_calc 0
...
execute if score #owned_item mwnc_calc matches 1.. run give @s minecraft:diamond_sword[custom_data={mwnc:{shop_bound:1b,shop_sword_diamond:1b}},custom_name={text:"Diamond Sword",color:"aqua",italic:false},enchantment_glint_override=true] 1
